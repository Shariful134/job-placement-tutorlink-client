    ...
    <div className="container mx-auto px-2 mt-10 md:mt-10 overflow-x-hidden">
      ...
      <div className=" grid grid-cols-12 gap-10 mt-5 ">
        ...
        <div className="col-span-9 w-full">
          {/* =====================all Tutor========================= */}
          <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 pr-5 md:pr-0 gap-4">
            {!Array.isArray(currentTutors) || currentTutors?.length === 0 ? (
              ...
              currentTutors?.map((tutor, index) => (
                <div
                  key={tutor._id || index}
                  className="relative group bg-base-100 dark:bg-black border border-gray-300 dark:border-gray-700 rounded-md overflow-hidden hover:shadow-sm transition duration-300"
                >
                  {/* Image & Hover Button */}
